package com.binaryic.binarysmartview.util;
...
public class TextUtils {
    public static String getGroupChannelTitle(Activity context,GroupChannel channel) {
        ...
        if (members.size() < 2) {
            ...
            for (User member : members) {
                if (member.getUserId().equals(LoginController.getLoginUser(context).getUser_ID())) {
                    continue;
                }
