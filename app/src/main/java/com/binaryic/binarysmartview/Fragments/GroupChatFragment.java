...
import com.binaryic.binarysmartview.Adapter.GroupChatAdapter;
...
import com.binaryic.binarysmartview.util.MediaPlayerActivity;
import com.binaryic.binarysmartview.util.PhotoViewerActivity;
...
import com.binaryic.binarysmartview.util.WebUtils;
...
public class GroupChatFragment extends Fragment {
    ...
    public static GroupChatFragment newInstance(@NonNull String channelUrl) {
        ...
        args.putString(ChannelListFragment.EXTRA_GROUP_CHANNEL_URL, channelUrl);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Log.e("STATE_CHANNEL_URL==", mChannelUrl);

        } else {
            // Get channel URL from GroupChannelListFragment.
            mChannelUrl = getArguments().getString(ChannelListFragment.EXTRA_GROUP_CHANNEL_URL);
            Log.e("EXTRA_GROUP_CHANNEL_URL==", mChannelUrl);

        }

        Log.e(LOG_TAG, mChannelUrl);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mMessageSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GroupController.changeStatus(getActivity(), mChannelUrl, "true");
                String userInput = mMessageEditText.getText().toString();

                Log.e("GroupChatFragment", "userInput==" + userInput);
...
*/
   /* @Override
    ...
    private void setUpChatListAdapter() {
        mChatAdapter.setItemClickListener(new GroupChatAdapter.OnItemClickListener() {
            ...
            public void onUserMessageItemClick(UserMessage message) {
                ...
                mChatAdapter.setOnItemLongClickListener(new GroupChatAdapter.OnItemLongClickListener() {
                    @Override
                    public void onUserMessageItemLongClick(final UserMessage message) {
    ...
    private void updateActionBarTitle() {
        ...
        if (mChannel != null) {
            title = TextUtils.getGroupChannelTitle(getActivity(),mChannel);
        }
    ...
    private void sendUserMessageWithUrl(final String text, String url) {
        Log.e("GroupChatFragment", "msg text==" + text);
        Log.e("GroupChatFragment", "msg url==" + url);
    ...
    private void sendUserMessage(String text) {
        Log.e("GroupChatFragment", "sendUserMessage text==" + text);

        List<String> urls = WebUtils.extractUrls(text);
        Log.e("GroupChatFragment", "urls ==" + urls.size());
    ...
    private void deleteMessage(final BaseMessage message) {
        mChannel.deleteMessage(message, new BaseChannel.DeleteMessageHandler() {
            ...
            public void onResult(SendBirdException e) {
                ...
                mChatAdapter.mMessageList.remove(message);
                mChatAdapter.notifyDataSetChanged();
